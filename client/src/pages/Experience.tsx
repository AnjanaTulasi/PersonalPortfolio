  ...
  const experiences = [
    {
      ...
      description: `Administered Oracle WebLogic and Fusion Middleware environments, supporting deployments, domain restarts, and cloud-integrated hybrid systems. Automated operational tasks and alert systems using WLST, Shell, and Python, improving efficiency and monitoring across Unix/Linux platforms. Resolved high-priority SOA/AIA and database performance issues, contributing to platform reliability and service continuity. Participated in Agile workflows using Jira for sprint tracking and collaborated with cross-functional teams to enhance cloud adoption strategies.`,
      logo: NextGenLogo
    },
    {
      ...
      description: `Completed intensive training in web development and database integration, gaining hands-on experience. As a Headstarter Fellow, contributed to full-stack development, API integration, database management, and UI/UX enhancements across multiple team and solo projects. Built personal portfolio website (HTML, CSS, Google Analytics) and Pantry Management App (Next.js, Material UI, Firebase) with end-to-end development and deployment.`,
    ...
    },
    {
      ...
      description: `Graduate Teaching Assistant: Mentored undergraduates in app development and cloud computing while grading assignments and preparing lecture materials. Conducted code reviews and edited IEEE research papers for technical accuracy and formatting standards. TRIO Tutor: Provided 1:1 tutoring in Mathematics and Computer Science, adapting support plans to meet diverse student needs. Conducted outreach for TRIO services and connected students with financial aid, career, and counseling resources.`,
